...
public final class Chapter05 {
    ...
    /**
     * 数値の書かれた文字列を受け取り、数値型に変換して戻り値に返しましょう。
     * 例）
     *  入力: "100"
     *  戻り: 100
     ...
     * @return 数値型に変換した値
     */
    public int cast_num(String num_text) {
        return 0;
    }
     ...
     */
    public List<String> split_words(String formula_text) {
        return null;
    }

    /**
     * 整数の書かれた文字列を2つ受け取って足し算の答えを返しましょう。
     * 例）
     *  入力: "1", "1"
     *  戻り: "2"
    ...
    /**
     * 整数の書かれた文字列を2つ受け取って引き算の答えを返しましょう。
     * 例）
     *  入力: "1", "1"
     *  戻り: "0"
     * @param num1 整数の書かれた文字列
    ...
    /**
     * 整数の書かれた文字列を2つ受け取って掛け算の答えを返しましょう。
     * 例）
     *  入力: "2", "3"
     *  戻り: "6"
     * @param num1 整数の書かれた文字列
    ...
    /**
     * 整数の書かれた文字列を2つ受け取って割り算の答えを返しましょう。
     * 例）
     *  入力: "6", "2"
     *  戻り: "3"
     * @param num1 整数の書かれた文字列
     ...
     * @return 計算結果の数値
     */
    public int calculator01(String formula_text) {
        List<String> words = split_words(formula_text);

        return 0;
    }

    /**
     * calculator01 を改良して掛け算と割り算に対応させましょう。
     * 使われる文字列は正の整数値以外に "+", "-", "×", "÷" があるものとします。
     ...
     * @return 計算結果の数値
     */
    public int calculator02(String formula_text) {
        List<String> words = split_words(formula_text);
     ...
     * @return 計算結果の数値
     */
    public int calculator03(String formula_text) {
        List<String> words = split_words(formula_text);
